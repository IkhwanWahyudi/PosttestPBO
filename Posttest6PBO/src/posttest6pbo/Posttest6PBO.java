...
public class Posttest6PBO {
    ...
    public static void main(String[] args) throws IOException {
        ...
        Analog addAnlg = new Analog("A035001", "Nixon", "4N40", 
                "Black", 230000, 200, "Date");
        anlg.add(addAnlg);
    ...
    public static void transaksi(){
        ...
        for(int i = 0; i < dataTransaksi.size(); i++){
            if (dataTransaksi.get(i).getStatus() == "Sukses"){
                dataTransaksi.get(i).TampilkanData();
                System.out.println("---------------------------------");
                total += dataTransaksi.get(i).TotalProfit();
            }
        }
        System.out.println("  Overall Profit = Rp." + total);
        System.out.println("---------------------------------");
    }
                            ...
                            while(!"E".equals(ulang)){
                                ...
                                if (jumlah > dgtl.get(beli-1).getStok() || jumlah <= 0){
                                    ...
                                    Transaksi buy = new Transaksi(namaCust, barang, 
                                            merk, kode, warna, fitur, "Proses",jumlah, harga);
